...
import { UserRepository } from '../../../src/usecases/register-user-on-mainling-list/ports'
import { RegisterUserOnMainlingList } from '../../../src/usecases/register-user-on-mainling-list'
